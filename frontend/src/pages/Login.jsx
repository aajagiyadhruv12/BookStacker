    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-blue-600 p-12 flex-col justify-between text-white relative overflow-hidden">
        <div className="relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-5xl font-black leading-tight mb-6">
              ...
              <span className="text-blue-200 text-6xl italic">Manage Knowledge.</span>
            </h1>
        ...
        <div className="relative z-10 flex items-center space-x-8 opacity-50">
          {[['10k+','Books'],['5k+','Readers'],['99.9%','Uptime']].map(([v,l]) => (
        ...
        <div className="absolute top-1/2 -right-20 w-60 h-60 bg-blue-400/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center min-h-screen bg-white px-6 py-12 sm:px-10">
        ...
        >
          ...
          <div className="flex md:hidden items-center gap-2 mb-8 justify-center">
            ...
            <span className="text-xl font-black text-gray-900">BookStacker</span>
          </div>

          <div className="mb-8">
            <h2 className="text-3xl font-black text-gray-900 mb-1">Login</h2>
            <p className="text-gray-500 font-medium text-sm">Enter your credentials to access your account.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="w-full pl-11 pr-4 py-3.5 bg-gray-50 rounded-2xl focus:ring-2 focus:ring-blue-400 outline-none text-gray-900 font-medium transition-all text-sm"
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className={`w-full bg-gray-900 text-white py-4 rounded-2xl font-black text-base flex items-center justify-center gap-2 shadow-lg hover:bg-gray-800 transition-all ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
          ...
          <p className="mt-8 text-center text-gray-500 font-medium text-sm">
            ...
            <Link to="/register" className="text-blue-600 font-black hover:underline">Create Account</Link>
          </p>
        </motion.div>
      </div>
    </div>
